...
```sh
vk.py @ https://github.com/prostomarkeloff/vk.py/archive/master.zip#egg=vk.py[fast]
```

With **ultra** handlers:
```sh
vk.py @ https://github.com/prostomarkeloff/vk.py/archive/master.zip#egg=vk.py[ultra]
```
