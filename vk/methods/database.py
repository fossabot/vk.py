...
class Database(BaseMethod):
    ...
    async def get_chairs(self,  faculty_id: int = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_cities(self,  country_id: int = None, region_id: int = None, q: str = None, need_all: bool = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_countries(self,  need_all: bool = None, code: str = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_faculties(self,  university_id: int = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_metro_stations(self,  city_id: int = None, offset: int = None, count: int = None, extended: bool = None,):
        '''
    ...
    async def get_regions(self,  country_id: int = None, q: str = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_schools(self,  q: str = None, city_id: int = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_universities(self,  q: str = None, country_id: int = None, city_id: int = None, offset: int = None, count: int = None,):
        '''
