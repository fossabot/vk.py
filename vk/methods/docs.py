...
class Docs(BaseMethod):
    ...
    async def add(self,  owner_id: int = None, doc_id: int = None, access_key: str = None,):
        '''
    ...
    async def edit(self,  owner_id: int = None, doc_id: int = None, title: str = None, tags: list = None,):
        '''
        Edits a document.
    ...
    async def get(self,  count: int = None, offset: int = None, type: int = None, owner_id: int = None,):
        '''
    ...
    async def search(self,  q: str = None, search_own: bool = None, count: int = None, offset: int = None,):
        '''
