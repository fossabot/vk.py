...
class Fave(BaseMethod):
    ...
    async def add_post(self,  owner_id: int = None, id: int = None, access_key: str = None,):
        '''
    ...
    async def add_product(self,  owner_id: int = None, id: int = None, access_key: str = None,):
        '''
    ...
    async def add_video(self,  owner_id: int = None, id: int = None, access_key: str = None,):
        '''
    ...
    async def get(self,  extended: bool = None, item_type: str = None, tag_id: int = None, offset: int = None, count: int = None, fields: str = None, is_from_snackbar: bool = None,):
        '''
    ...
    async def get_pages(self,  offset: int = None, count: int = None, type: str = None, fields: list = None, tag_id: int = None,):
        '''
    ...
    async def set_page_tags(self,  user_id: int = None, group_id: int = None, tag_ids: list = None,):
        '''
    ...
    async def set_tags(self,  item_type: str = None, item_owner_id: int = None, item_id: int = None, tag_ids: list = None, link_id: str = None, link_url: str = None,):
        '''
