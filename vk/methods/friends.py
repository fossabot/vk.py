...
class Friends(BaseMethod):
    ...
    async def edit_list(self,  name: str = None, list_id: int = None, user_ids: list = None, add_user_ids: list = None, delete_user_ids: list = None,):
        '''
    ...
    async def get(self,  user_id: int = None, order: str = None, list_id: int = None, count: int = None, offset: int = None, fields: list = None, name_case: str = None, ref: str = None,):
        '''
    ...
    async def get_mutual(self,  source_uid: int = None, target_uid: int = None, target_uids: list = None, order: str = None, count: int = None, offset: int = None,):
        '''
    ...
    async def get_online(self,  user_id: int = None, list_id: int = None, online_mobile: bool = None, order: str = None, count: int = None, offset: int = None,):
        '''
    ...
    async def get_requests(self,  offset: int = None, count: int = None, extended: bool = None, need_mutual: bool = None, out: bool = None, sort: int = None, need_viewed: bool = None, suggested: bool = None, ref: str = None, fields: list = None,):
        '''
    ...
    async def get_suggestions(self,  filter: list = None, count: int = None, offset: int = None, fields: list = None, name_case: str = None,):
        '''
    ...
    async def search(self,  user_id: int = None, q: str = None, fields: list = None, name_case: str = None, offset: int = None, count: int = None,):
        '''
