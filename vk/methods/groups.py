...
class Groups(BaseMethod):
    ...
    async def add_address(self,  group_id: int = None, title: str = None, address: str = None, additional_address: str = None, country_id: int = None, city_id: int = None, metro_id: int = None, latitude: Union[int, float] = None, longitude: Union[int, float] = None, phone: str = None, work_info_status: str = None, timetable: str = None, is_main_address: bool = None ,):
        '''
    ...
    async def add_callback_server(self,  group_id: int = None, url: str = None, title: str = None, secret_key: str = None ,):
        '''
    ...
    async def ban(self,  group_id: int = None, owner_id: int = None, end_date: int = None, reason: int = None, comment: str = None, comment_visible: bool = None ,):
        '''
    ...
    async def create(self,  title: str = None, description: str = None, type: str = None, public_category: int = None, subtype: int = None ,):
        '''
    ...
    async def edit(self,  group_id: int = None, title: str = None, description: str = None, screen_name: str = None, access: int = None, website: str = None, subject: str = None, email: str = None, phone: str = None, rss: str = None, event_start_date: int = None, event_finish_date: int = None, event_group_id: int = None, public_category: int = None, public_subcategory: int = None, public_date: str = None, wall: int = None, topics: int = None, photos: int = None, video: int = None, audio: int = None, links: bool = None, events: bool = None, places: bool = None, contacts: bool = None, docs: int = None, wiki: int = None, messages: bool = None, articles: bool = None, addresses: bool = None, age_limits: int = None, market: bool = None, market_comments: bool = None, market_country: list = None, market_city: list = None, market_currency: int = None, market_contact: int = None, market_wiki: int = None, obscene_filter: bool = None, obscene_stopwords: bool = None, obscene_words: list = None, main_section: int = None, secondary_section: int = None, country: int = None, city: int = None ,):
        '''
        Edits a community.
        :param group_id: Community ID.
        :param title: Community title.
    ...
    async def edit_address(self,  group_id: int = None, address_id: int = None, title: str = None, address: str = None, additional_address: str = None, country_id: int = None, city_id: int = None, metro_id: int = None, latitude: Union[int, float] = None, longitude: Union[int, float] = None, phone: str = None, work_info_status: str = None, timetable: str = None, is_main_address: bool = None ,):
        '''
    ...
    async def edit_callback_server(self,  group_id: int = None, server_id: int = None, url: str = None, title: str = None, secret_key: str = None ,):
        '''
    ...
    async def edit_link(self,  group_id: int = None, link_id: int = None, text: str = None ,):
        '''
    ...
    async def edit_manager(self,  group_id: int = None, user_id: int = None, role: str = None, is_contact: bool = None, contact_position: str = None, contact_phone: str = None, contact_email: str = None ,):
        '''
    ...
    async def get(self,  user_id: int = None, extended: bool = None, filter: list = None, fields: list = None, offset: int = None, count: int = None ,):
        '''
    ...
    async def get_addresses(self,  group_id: int = None, address_ids: list = None, latitude: Union[int, float] = None, longitude: Union[int, float] = None, offset: int = None, count: int = None, fields: list = None ,):
        '''
    ...
    async def get_banned(self,  group_id: int = None, offset: int = None, count: int = None, fields: list = None, owner_id: int = None ,):
        '''
    ...
    async def get_by_id(self,  group_ids: list = None, group_id: str = None, fields: list = None ,):
        '''
    ...
    async def get_invited_users(self,  group_id: int = None, offset: int = None, count: int = None, fields: list = None, name_case: str = None ,):
        '''
    ...
    async def get_invites(self,  offset: int = None, count: int = None, extended: bool = None ,):
        '''
    ...
    async def get_members(self,  group_id: str = None, sort: str = None, offset: int = None, count: int = None, fields: list = None, filter: str = None ,):
        '''
    ...
    async def get_requests(self,  group_id: int = None, offset: int = None, count: int = None, fields: list = None ,):
        '''
    ...
    async def is_member(self,  group_id: str = None, user_id: int = None, user_ids: list = None, extended: bool = None ,):
        '''
    ...
    async def reorder_link(self,  group_id: int = None, link_id: int = None, after: int = None ,):
        '''
    ...
    async def search(self,  q: str = None, type: str = None, country_id: int = None, city_id: int = None, future: bool = None, market: bool = None, sort: int = None, offset: int = None, count: int = None ,):
        '''
