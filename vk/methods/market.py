...
class Market(BaseMethod):
    async def add(self,  owner_id: int = None, name: str = None, description: str = None, category_id: int = None, price: Union[int, float] = None, old_price: Union[int, float] = None, deleted: bool = None, main_photo_id: int = None, photo_ids: list = None, url: str = None,):
        '''
    ...
    async def add_album(self,  owner_id: int = None, title: str = None, photo_id: int = None, main_album: bool = None,):
        '''
    ...
    async def add_to_album(self,  owner_id: int = None, item_id: int = None, album_ids: list = None,):
        '''
    ...
    async def create_comment(self,  owner_id: int = None, item_id: int = None, message: str = None, attachments: list = None, from_group: bool = None, reply_to_comment: int = None, sticker_id: int = None, guid: str = None,):
        '''
    ...
    async def edit(self,  owner_id: int = None, item_id: int = None, name: str = None, description: str = None, category_id: int = None, price: Union[int, float] = None, deleted: bool = None, main_photo_id: int = None, photo_ids: list = None, url: str = None,):
        '''
        Edits an item.
        :param owner_id: ID of an item owner community.
        :param item_id: Item ID.
    ...
    async def edit_album(self,  owner_id: int = None, album_id: int = None, title: str = None, photo_id: int = None, main_album: bool = None,):
        '''
    ...
    async def edit_comment(self,  owner_id: int = None, comment_id: int = None, message: str = None, attachments: list = None,):
        '''
    ...
    async def get(self,  owner_id: int = None, album_id: int = None, count: int = None, offset: int = None, extended: bool = None,):
        '''
    ...
    async def get_albums(self,  owner_id: int = None, offset: int = None, count: int = None,):
        '''
    ...
    async def get_comments(self,  owner_id: int = None, item_id: int = None, need_likes: bool = None, start_comment_id: int = None, offset: int = None, count: int = None, sort: str = None, extended: bool = None, fields: list = None,):
        '''
    ...
    async def remove_from_album(self,  owner_id: int = None, item_id: int = None, album_ids: list = None,):
        '''
    ...
    async def reorder_albums(self,  owner_id: int = None, album_id: int = None, before: int = None, after: int = None,):
        '''
    ...
    async def reorder_items(self,  owner_id: int = None, album_id: int = None, item_id: int = None, before: int = None, after: int = None,):
        '''
    ...
    async def report(self,  owner_id: int = None, item_id: int = None, reason: int = None,):
        '''
    ...
    async def report_comment(self,  owner_id: int = None, comment_id: int = None, reason: int = None,):
        '''
    ...
    async def search(self,  owner_id: int = None, album_id: int = None, q: str = None, price_from: int = None, price_to: int = None, tags: list = None, sort: int = None, rev: int = None, offset: int = None, count: int = None, extended: bool = None, status: int = None,):
        '''
