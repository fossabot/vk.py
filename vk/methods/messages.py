...
class Messages(BaseMethod):
    ...
    async def delete(self,  message_ids: list = None, spam: bool = None, group_id: int = None, delete_for_all: bool = None,):
        '''
    ...
    async def delete_conversation(self,  user_id: int = None, peer_id: int = None, group_id: int = None,):
        '''
    ...
    async def edit(self,  peer_id: int = None, message: str = None, message_id: int = None, lat: Union[int, float] = None, long: Union[int, float] = None, attachment: str = None, keep_forward_messages: bool = None, keep_snippets: bool = None, group_id: int = None, dont_parse_links: bool = None,):
        '''
        Edits the message.
        :param peer_id: Destination ID. "For user: 'User ID', e.g. '12345'. For chat: '2000000000' + 'chat_id', e.g. '2000000001'. For community: '- community ID', e.g. '-12345'. "
    ...
    async def get_by_conversation_message_id(self,  peer_id: int = None, conversation_message_ids: list = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_by_id(self,  message_ids: list = None, preview_length: int = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_chat_preview(self,  peer_id: int = None, link: str = None, fields: list = None,):
        '''
    ...
    async def get_conversation_members(self,  peer_id: int = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_conversations(self,  offset: int = None, count: int = None, filter: str = None, extended: bool = None, start_message_id: int = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_conversations_by_id(self,  peer_ids: list = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_history(self,  offset: int = None, count: int = None, user_id: int = None, peer_id: int = None, start_message_id: int = None, rev: int = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def get_history_attachments(self,  peer_id: int = None, media_type: str = None, start_from: str = None, count: int = None, photo_sizes: bool = None, fields: list = None, group_id: int = None, preserve_order: bool = None, max_forwards_level: int = None,):
        '''
    ...
    async def get_invite_link(self,  peer_id: int = None, reset: bool = None, group_id: int = None,):
        '''
    ...
    async def get_long_poll_history(self,  ts: int = None, pts: int = None, preview_length: int = None, onlines: bool = None, fields: list = None, events_limit: int = None, msgs_limit: int = None, max_msg_id: int = None, group_id: int = None, lp_version: int = None, last_n: int = None, credentials: bool = None,):
        '''
    ...
    async def get_long_poll_server(self,  need_pts: bool = None, group_id: int = None, lp_version: int = None,):
        '''
    ...
    async def is_messages_from_group_allowed(self,  group_id: int = None, user_id: int = None,):
        '''
    ...
    async def mark_as_answered_conversation(self,  peer_id: int = None, answered: bool = None, group_id: int = None,):
        '''
    ...
    async def mark_as_important_conversation(self,  peer_id: int = None, important: bool = None, group_id: int = None,):
        '''
    ...
    async def mark_as_read(self,  message_ids: list = None, peer_id: int = None, start_message_id: int = None, group_id: int = None,):
        '''
    ...
    async def remove_chat_user(self,  chat_id: int = None, user_id: int = None, member_id: int = None,):
        '''
    ...
    async def search(self,  q: str = None, peer_id: int = None, date: int = None, preview_length: int = None, offset: int = None, count: int = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def search_conversations(self,  q: str = None, count: int = None, extended: bool = None, fields: list = None, group_id: int = None,):
        '''
    ...
    async def send(self,  user_id: int = None, random_id: int = None, peer_id: int = None, domain: str = None, chat_id: int = None, user_ids: list = None, message: str = None, lat: Union[int, float] = None, long: Union[int, float] = None, attachment: str = None, reply_to: int = None, forward_messages: list = None, forward: str = None, sticker_id: int = None, group_id: int = None, keyboard: str = None, payload: str = None, dont_parse_links: bool = None, disable_mentions: bool = None,):
        '''
        Sends a message.
    ...
    async def set_activity(self,  user_id: int = None, type: str = None, peer_id: int = None, group_id: int = None,):
        '''
